...
//                    isString: true
            ...
            messages: {
                ...
                area_propried: {
                    minlength:  "Informação Inválida! Por Favor, Informe o Tamanho da Area da Propriedade"
                },
                area_requer: {
                    minlength:  "Informação Inválida! Por Favor, Informe o Tamanho da Area Rquerida"
                }
...
<div class="row">
    <div class="col-sm-6">
        <h3><strong>CADASTRO AUTORIZAÇÃO</strong></h3>
    </div>
...
<div class="panel-group">
    <form  action="recebe_cad_autorizacao.php"  method="POST" name="frmautorizacao" id="frmautorizacao">
                            ...
                            <div class="row">
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="numero_autorizacao" id="numero_autorizacao" class="form-control" autofocus/>                                       
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="data_emissao" id="data_emissao" onblur="comparaAnoData()" class="form-control"/>                                       
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-12" id="DETALHES_AUTORIZACAO">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="informacao_autorizacao" id="informacao_autorizacao"  class="form-control"/>                                     
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6" id="AREA_PROPRIEDADE">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="area_propried" id="area_propried" class="form-control"/>                                     
                                    </div>
                                </div>
                                <div class="col-sm-6" id="AREA_REQUERIDA">
                                    <div class="form-group">
                                        <label for="area_requer"><strong>ÁREA REQUERIDA PARA SUPRESSÃO</strong></label><br/>
                                        <input type="text" name="area_requer" id="area_requer" class="form-control"/>                                     
                                    </div>
                                </div>
                            </div>
                            <div class="row">
