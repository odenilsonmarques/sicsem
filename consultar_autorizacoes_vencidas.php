...
$sql_autorizacoes = "SELECT  *FROM tb_autorizacao WHERE data_validade < curdate()";
...
<form name="fmrpesquisa">
    ...
    <div class="row">
        ...
        <div class="col-sm-2" style="">
            <input type="text" name="parametro_numero" class="form-control" placeholder="Nº da Autorização" >
        </div>        
        ...
        <div class="col-sm-7" style="text-align: right"> 
            ...
            <ul class="dropdown-menu">
             ...
             <div  class="btn btn-success">
                 <a href="consultar_autorizacoes.php" style="font-size:px; font-weight:bold; color:white; text-decoration:none">Autorizações</a>
            </div>
...
<table class="table table-striped table-hover table-bordered">
    ...
    $sql = "SELECT tb_autorizacao.codigo_autorizacao,tb_autorizacao.numero_autorizacao,tb_autorizacao.data_emissao,tb_autorizacao.data_validade,tb_autorizacao.autorizacao,tb_empresa.razaosocial_pessoafisica,tb_processo.numero_processo,tb_empreendimento.nome_empreendimento,
            (if(current_date()<= data_validade,'<strong>DENTRO DO PRAZO</strong>','<strong style=color:#FFF>PRAZO VENCIDO<strong>')) AS situacao 
            FROM 
    ...
    if (mysqli_num_rows($recebe) > 0) {
        ...
        while ($linhas = mysqli_fetch_array($recebe)) {
            ...
            echo'<td><a href=relatorio_licencas.php?codigo_licenca=' . $autorizacoes . ' target="_blank"><img src="img/printer.png"></a></td>';
            echo'</tr>';
        }
        //exibe a paginação 
        ...
        echo "<a href='consultar_autorizacoes_vencidas.php'style='color:blue'><strong>EXIBIR AUTORIZACÕES VENCIDAS</strong></a></div>";
    }
    ?>
    <style type="text/css">
        ul {
