...
//                                        if (isset($_POST['telefone']) && empty($_POST['telefone']) == FALSE) {
                ...
                //verifacando se o nome da razao social / pessoa fisica já está cadastrado(VERIFICAÇÃO TEMPORARIAMENTE SUSPENS , POIS UMA EMPRESA PODE TER O MEMO NOME MAS CPJ/CPF DIFERENTE, EX: EMPREENDIMENTO PAGUE MENOS)
